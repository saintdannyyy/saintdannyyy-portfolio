...
const experiences = [
  {
    ...
    duration: "2+ years",
    description:
      "Led a team of 5 developers in building scalable microservices architecture. Implemented CI/CD pipelines that reduced deployment time by 70%. Mentored junior developers and drove technical decisions for cloud migration.",
    technologies: [
      "React",
      "Node.js",
      "AWS",
    ...
    achievements: [
      ...
      "Reduced cloud costs by $50k annually",
  ...
  },
  {
    ...
    duration: "2 years",
    description:
      "Built and maintained customer-facing applications serving 100k+ users. Developed RESTful APIs and integrated third-party services. Collaborated with design team to implement pixel-perfect UI components.",
    technologies: ["React", "Python", "PostgreSQL", "Redis", "GraphQL", "Jest"],
    achievements: [
